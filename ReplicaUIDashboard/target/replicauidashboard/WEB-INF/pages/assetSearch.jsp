...
<tbody>
                                         <c:forEach items="${assets}" var="asset">
                                                       ...
                                                       <tr>
                                                              ...
                                                              <td><a title="${asset.lPath}" >
                                                                           <c:set var="assetlpath" value='${asset.lPath}' /> <c:if
                                                                                  test="${fn:length(assetlpath) > 30}">${fn:substring(assetlpath, 0, 27)}...</c:if></a>
                                                                           <c:if test="${fn:length(assetlpath) <= 30}">${asset.lPath}</c:if>
                                                              </td>
                                         ...
                                         <c:if test="${ (asset.filesize < 1024) }">
                                                              ...
                                                              <td><a title="${asset.tombstoneDate}"
                                                                     > <c:set
                                                                                  var="assettombstone_date" value='${asset.tombstoneDate}' />
                                                                           <c:if test="${(assettombstone_date) == null}">Active</c:if> <c:if
                                                                                  test="${(assettombstone_date) != null}">InActive</c:if>
                                                              </a></td>
